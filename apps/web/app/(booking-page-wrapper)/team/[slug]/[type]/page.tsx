...
//
// Mirrors apps/web/app/(booking-page-wrapper)/[user]/[type]/page.tsx, pointed
// at the team loader. The public booker view is shared: it renders from
// eventData, which getPublicEvent already populates for team events.
